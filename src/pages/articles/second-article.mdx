...
title: Rob Fitzpatrick "Mom's Test"
publishDate: 13 Sep 2022
description: You can choose your own theme from this [library](https://github.com/shikijs/shiki/blob/main/docs/themes.md#all-themes), which is currently set to Dracula, in the file `astro.config.mjs`.
tags: ["CusDev", "Managament", "Product"]
value: 0
---
