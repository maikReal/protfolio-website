...
title: How to solve daily problems?
publishDate: 13 May 2022
description: Following is an example blog post written in an md file. You can find me @ src/pages/posts/hello-world.md. Here you can add/update/delete details and watch the changes live when running in develop mode.
...
<img class="articleMainImg" src="https://thumbs.dreamstime.com/b/rrabbit-5361563.jpg" alt="A covered up pug in the woods" width={550} height={460}/>
