...
<img class="mx-auto w-[100%] rounded-[10px]" src="/static/ArticlesImages/spotify-stages.png" alt="spotify-model"/>

The main idea of the process is to decrease the period for “Build It” and “Ship It” stages, because we can’t decrease risks and spent resources for them. On “Tweak It” stage risks and spent resources can decrease over time, because made less experiments with feature or product part.
